...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'Versa Exchange',
    'page.body.landing.marketInfo.title.text2': 'Buy, Sell, Swap, Exchange!',
    'page.body.landing.marketInfo.title.button': 'Launch App',

    'page.body.landing.register.item.title': 'Built For Investors',
    'page.body.landing.register.item.text': 'Versa Exchange offers new and experienced investors a simple UI for simple daily transactions.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'Features',
    ...
    'page.body.landing.features.features.item1.text': 'VersaExchange offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'VersaExchange offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.title': 'Global Access',
    'page.body.landing.tradeOnTheGo.item.text1': 'Our platform is optimized for trading on any device.',
    'page.body.landing.tradeOnTheGo.item.text2': 'Open your browser, Sign in and thats it!',
    'page.body.landing.tradeOnTheGo.item.text3': 'The Versa Exchange platform is available everywhere you go.',
    'page.body.landing.tradeOnTheGo.item.button': 'Launch App',

    'page.body.landing.startTrading.title': 'Ready to get started?',
    ...
    'page.body.landing.footer.rights': 'VersaExchange © All rights reserved.',

    'pagy.body.footer.powered_by': 'Provided by',
    ...
    'page.body.wallets.tabs.deposit.disabled.message': 'Deposit is not available at this time',
    ...
    'page.body.wallets.tabs.deposit.fiat.message2': 'Please use the following credentials to initiate your bank transfer. Your deposit will be reflected in your account within 2 business days. Our fee is set at 16%.',
    ...
    'page.body.wallets.tabs.deposit.fiat.admin': ' To initiate a fiat withdrawal, please contact (support@versaex.ca).',
    ...
    'page.body.wallets.tabs.withdraw.disabled.message': 'Withdrawal is not available at this time',
